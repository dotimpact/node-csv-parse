...
module.exports = function () {
  ...
  if (arguments.length === 3) {
    ...
    if (typeof callback !== 'function') {
      throw Error('Invalid callback argument: ' + (0, _stringify2.default)(callback));
    }
    if (!(typeof data === 'string' || Buffer.isBuffer(arguments[0]))) {
      return callback(Error('Invalid data argument: ' + (0, _stringify2.default)(data)));
    }
    ...
    if (typeof arguments[0] === 'string' || Buffer.isBuffer(arguments[0])) {
      ...
      err = 'Invalid first argument: ' + (0, _stringify2.default)(arguments[0]);
    }
    ...
    if (typeof arguments[1] === 'function') {
      ...
      err = 'Invalid first argument: ' + (0, _stringify2.default)(arguments[1]);
    }
    if (err) {
      if (!callback) {
        throw Error(err);
...
Parser = function Parser() {
  ...
  this._ = {
    ...
    rawBuf: '',
    buf: '',
    rowDelimiterLength: this.options.rowDelimiter ? Math.max.apply(Math, (0, _toConsumableArray3.default)(this.options.rowDelimiter.map(function (v) {
      return v.length;
    }))) : void 0
  };
  return this;
...
Parser.prototype.__push = function (line) {
  ...
  if (this.options.columns === true) {
    ...
    var _call_column_udf2 = (0, _slicedToArray3.default)(_call_column_udf, 2);
...
Parser.prototype.__write = function (chars, end) {
  ...
  while (i < l) {
      ...
      if (this._.quoting) {
        ...
        if (this._.nextChar && !areNextCharsRowDelimiters && !areNextCharsDelimiter && !isNextCharAComment) {
          if (this.options.relax) {
            ...
            return Error('Invalid closing quote at line ' + (this.lines + 1) + '; found ' + (0, _stringify2.default)(this._.nextChar) + ' instead of delimiter ' + (0, _stringify2.default)(this.options.delimiter));
          }
        } else {
          this._.quoting = false;
    ...
    if (!this._.commenting && ((ref2 = this._.field) != null ? ref2.length : void 0) > this.options.max_limit_on_data_read) {
      return Error('Field exceeds max_limit_on_data_read setting (' + this.options.max_limit_on_data_read + ') ' + (0, _stringify2.default)(this.options.delimiter));
    }
    if (!this._.commenting && ((ref3 = this._.line) != null ? ref3.length : void 0) > this.options.max_limit_on_data_read) {
      return Error('Row delimiter not found in the file ' + (0, _stringify2.default)(this.options.rowDelimiter));
    }
  }
  ...
  if (end) {
    ...
    if (((ref5 = this._.field) != null ? ref5.length : void 0) > this.options.max_limit_on_data_read) {
      return Error('Delimiter not found in the file ' + (0, _stringify2.default)(this.options.delimiter));
    }
    if (l === 0) {
      this.lines++;
    }
...
isObjLiteral = function isObjLiteral(_obj) {
  var _test;
  _test = _obj;
  if ((typeof _obj === 'undefined' ? 'undefined' : (0, _typeof3.default)(_obj)) !== 'object' || _obj === null || Array.isArray(_obj)) {
    return false;
  } else {
    return function () {
      while (!false) {
        if ((0, _getPrototypeOf2.default)(_test = (0, _getPrototypeOf2.default)(_test)) === null) {
          break;
        }
      }
      return (0, _getPrototypeOf2.default)(_obj === _test);
    }();
  }
};
